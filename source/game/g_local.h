...
typedef struct {
	...
	//[/ExpSys]
   int	 chatIgnoreClients[2];		// MJN - Clients which are ignoring this client. [0] = (0-31)  [1] = (32-63) // RoAR mod NOTE: Wrong place = catastrophy?
	qboolean	sawMOTD;			// has the client been shown the MOTD?
...
typedef struct {
   ...
   int			clannameTime;				// Last time the clan name was changed
...
struct gclient_s {
	...
	qboolean	ojpClientPlugIn; //v1.00+
	qboolean	ojpClientPlugIn2; //v1.05
	qboolean	ojpClientPlugIn3; //v1.06
	...
	int			saberTimeLeft;					// To fix saber glitch ^-^
	int			speakTimeLeft;					// To fix speak whorage ^-^
	int			itsNewsTime1;					// made for news k? ^-^
	int			itsNewsTime2;
	int			itsNewsTime3;
...
typedef struct {
	...
	*/
	...
	qboolean	isLockedred;			// MJN : See if red team is locked.
	qboolean	isLockedblue;			// MJN : See if blue team is locked.
	qboolean	isLockedspec;			// MJN : Lock Spectator mode.
	qboolean	isLockedjoin;			// RoAR mod : Lock Join mode.
} level_locals_t;
...
extern  vmCvar_t	roar_adminControl1;
extern  vmCvar_t	roar_adminControl2;
extern  vmCvar_t	roar_adminControl3;
extern  vmCvar_t	roar_adminControl4;
extern  vmCvar_t	roar_adminControl5;
...
extern vmCvar_t		roar_allow_black_names;
extern vmCvar_t		roar_console_motd;
extern vmCvar_t		d_slowmodeath;
//extern vmCvar_t		d_saberSPStyleDamage; //RoAR mod NOTE: Removed in 1.05

extern vmCvar_t		roar_FPGRIPspeed;

extern vmCvar_t		roar_RollTypes;

extern vmCvar_t		roar_BotFakePings;

//RoAR mod CUSTOM SAYINGS BEGIN
extern vmCvar_t		roar_protect_on_saying;
extern vmCvar_t		roar_protect_off_saying;
extern vmCvar_t		roar_protect_on_ALL_saying;
extern vmCvar_t		roar_protect_off_ALL_saying;

extern vmCvar_t		roar_terminator_on_saying;
extern vmCvar_t		roar_terminator_off_saying;
extern vmCvar_t		roar_terminator_on_ALL_saying;
extern vmCvar_t		roar_terminator_off_ALL_saying;

extern vmCvar_t		roar_sleep_on_saying;
extern vmCvar_t		roar_sleep_off_saying;
extern vmCvar_t		roar_sleep_on_ALL_saying;
extern vmCvar_t		roar_sleep_off_ALL_saying;

extern vmCvar_t		roar_punish_on_saying;
extern vmCvar_t		roar_punish_off_saying;
extern vmCvar_t		roar_slap_saying;

extern vmCvar_t		roar_news1_content;
extern vmCvar_t		roar_news2_content;
extern vmCvar_t		roar_news3_content;
extern vmCvar_t		roar_news1_time;
extern vmCvar_t		roar_news2_time;
extern vmCvar_t		roar_news3_time;

extern vmCvar_t		roar_human_on_saying;
extern vmCvar_t		roar_human_off_saying;
extern vmCvar_t		roar_monk_on_ALL_saying;
extern vmCvar_t		roar_monk_off_ALL_saying;

extern vmCvar_t		roar_teleport_saying;

extern vmCvar_t		roar_scale_saying;

extern vmCvar_t		roar_renameclan_saying;

extern vmCvar_t		roar_idle_AutoProtect_timer;

extern vmCvar_t		roar_allow_chatColors;

extern vmCvar_t		roar_empower_on_saying;
extern vmCvar_t		roar_empower_off_saying;
extern vmCvar_t		roar_empower_on_ALL_saying;
extern vmCvar_t		roar_empower_off_ALL_saying;

extern vmCvar_t		roar_demigod_on_saying;
extern vmCvar_t		roar_demigod_off_saying;

extern vmCvar_t		roar_freeze_on_saying;
extern vmCvar_t		roar_freeze_off_saying;
extern vmCvar_t		roar_freeze_on_ALL_saying;
extern vmCvar_t		roar_freeze_off_ALL_saying;

extern vmCvar_t		roar_splat_saying;

extern vmCvar_t		roar_silence_on_saying;
extern vmCvar_t		roar_silence_off_saying;
...
extern vmCvar_t		roar_insult_silence_on_saying;
extern vmCvar_t		roar_insult_silence_off_saying;

extern vmCvar_t		roar_slay_saying;
extern vmCvar_t		roar_banned_saying;
//RoAR mod CUSTOM SAYINGS END
extern vmCvar_t		roar_chat_protection;
extern vmCvar_t		roar_disable_slideOnHeads;
extern vmCvar_t		roar_enable_ForceDuel;
extern vmCvar_t		roar_enable_TrainingDuel;
extern vmCvar_t		roar_enable_MeleeDuel;
extern vmCvar_t		roar_enable_NormalDuel;
extern vmCvar_t		roar_duel_begin_autobow;

extern vmCvar_t		roar_enable_ledgegrab;

extern vmCvar_t		roar_enable_ForceKickFlip;

extern vmCvar_t		roar_JK2yellowDFA;
extern vmCvar_t		roar_allow_samePlayerNames;

extern vmCvar_t		clan_website;
extern vmCvar_t		clan_initials;
extern vmCvar_t		clan_fullname;
extern vmCvar_t		clan_founders;
extern vmCvar_t		clan_recruiting;
extern vmCvar_t		clan_laming;
extern vmCvar_t		clan_moreinfo;

extern vmCvar_t		roar_remove_duel_radius;

extern vmCvar_t		roar_display_ending_duel_status;

extern vmCvar_t		roar_starting_weapons;

extern vmCvar_t		roar_elevator_1_hit_kill;

extern vmCvar_t		roar_grip_open_saber;

extern vmCvar_t		roar_allow_jetpack_command;

extern vmCvar_t		roar_allow_dropsaber_command;

extern vmCvar_t		roar_allow_KnockMeDown_command;

extern vmCvar_t		roar_allow_auto_saber_switching;

extern vmCvar_t		roar_spectate_keep_score;
extern vmCvar_t		roar_IdleSaberDmg;
extern vmCvar_t		sv_maxConnections;

// MJN - Cvars
extern vmCvar_t	g_mSaberDMGTwirl;
extern vmCvar_t	g_mSaberDMGKick;
extern vmCvar_t	g_mSaberDMGDualKata;
extern vmCvar_t	g_mSaberDMGStaffKataMin;
extern vmCvar_t	g_mSaberDMGStaffKataMax;
extern vmCvar_t	g_mSaberDMGMultiMin;
extern vmCvar_t	g_mSaberDMGMultiMax;
extern vmCvar_t	g_mSaberDMGSpecialMin;
extern vmCvar_t	g_mSaberDMGSpecialMax;
extern vmCvar_t	g_mSaberDMGRedNormal;
extern vmCvar_t	g_mSaberDMGRedNormalMin;
extern vmCvar_t	g_mSaberDMGRedNormalMax;
extern vmCvar_t	g_mSaberDMGRedDFAMin;
extern vmCvar_t	g_mSaberDMGRedDFAMax;
extern vmCvar_t	g_mSaberDMGRedBackMin;
extern vmCvar_t	g_mSaberDMGRedBackMax;
extern vmCvar_t	g_mSaberDMGYellowNormal;
extern vmCvar_t	g_mSaberDMGYellowOverheadMin;
extern vmCvar_t	g_mSaberDMGYellowOverheadMax;
extern vmCvar_t	g_mSaberDMGYellowBackMin;
extern vmCvar_t	g_mSaberDMGYellowBackMax;
extern vmCvar_t	g_mSaberDMGBlueNormal;
extern vmCvar_t	g_mSaberDMGBlueLungeMin;
extern vmCvar_t	g_mSaberDMGBlueLungeMax;
extern vmCvar_t	g_mSaberDMGBlueBackMin;
extern vmCvar_t	g_mSaberDMGBlueBackMax;

extern vmCvar_t	gsess;

extern int dueltypes[MAX_CLIENTS];
extern int Tforce[MAX_CLIENTS];
