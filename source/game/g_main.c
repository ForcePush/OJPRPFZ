...
vmCvar_t		roar_adminControl1;
vmCvar_t		roar_adminControl2;
vmCvar_t		roar_adminControl3;
vmCvar_t		roar_adminControl4;
vmCvar_t		roar_adminControl5;
...
vmCvar_t		g_clanPassword;
vmCvar_t	mod_saberBoxSize;

vmCvar_t		roar_BotFakePings;

vmCvar_t		roar_protect_on_saying;
vmCvar_t		roar_protect_off_saying;
vmCvar_t		roar_protect_on_ALL_saying;
vmCvar_t		roar_protect_off_ALL_saying;

vmCvar_t		roar_terminator_on_saying;
vmCvar_t		roar_terminator_off_saying;
vmCvar_t		roar_terminator_on_ALL_saying;
vmCvar_t		roar_terminator_off_ALL_saying;

vmCvar_t		roar_sleep_on_saying;
vmCvar_t		roar_sleep_off_saying;
vmCvar_t		roar_sleep_on_ALL_saying;
vmCvar_t		roar_sleep_off_ALL_saying;

vmCvar_t		roar_punish_on_saying;
vmCvar_t		roar_punish_off_saying;
vmCvar_t		roar_slap_saying;

vmCvar_t		roar_news1_content;
vmCvar_t		roar_news2_content;
vmCvar_t		roar_news3_content;
vmCvar_t		roar_news1_time;
vmCvar_t		roar_news2_time;
vmCvar_t		roar_news3_time;

vmCvar_t		debug;

vmCvar_t		roar_human_on_saying;
vmCvar_t		roar_human_off_saying;
vmCvar_t		roar_monk_on_ALL_saying;
vmCvar_t		roar_monk_off_ALL_saying;

vmCvar_t		roar_teleport_saying;

vmCvar_t		roar_scale_saying;

vmCvar_t		roar_renameclan_saying;

vmCvar_t		roar_RollTypes;

vmCvar_t		roar_idle_AutoProtect_timer;

vmCvar_t		roar_ClanLogin_saying;
vmCvar_t		roar_ClanLogout_saying;

vmCvar_t		roar_FPGRIPspeed;

vmCvar_t		roar_allow_chatColors;

vmCvar_t		roar_empower_on_saying;
vmCvar_t		roar_empower_off_saying;
vmCvar_t		roar_empower_on_ALL_saying;
vmCvar_t		roar_empower_off_ALL_saying;

vmCvar_t		roar_demigod_on_saying;
vmCvar_t		roar_demigod_off_saying;

vmCvar_t		roar_freeze_on_saying;
vmCvar_t		roar_freeze_off_saying;
vmCvar_t		roar_freeze_on_ALL_saying;
vmCvar_t		roar_freeze_off_ALL_saying;

vmCvar_t		roar_splat_saying;

vmCvar_t		roar_silence_on_saying;
vmCvar_t		roar_silence_off_saying;
...
vmCvar_t		roar_insult_silence_on_saying;
vmCvar_t		roar_insult_silence_off_saying;

vmCvar_t		roar_disable_slideOnHeads;

vmCvar_t		roar_slay_saying;

vmCvar_t		clan_website;
vmCvar_t		clan_fullname;
vmCvar_t		clan_initials;
vmCvar_t		clan_founders;
vmCvar_t		clan_initials;
vmCvar_t		clan_recruiting;
vmCvar_t		clan_laming;
vmCvar_t		clan_moreinfo;

vmCvar_t		roar_banned_saying;

vmCvar_t		roar_display_ending_duel_status;

vmCvar_t		roar_remove_duel_radius;
vmCvar_t		roar_console_motd;
vmCvar_t		roar_starting_weapons;

vmCvar_t		roar_elevator_1_hit_kill;
vmCvar_t		roar_grip_open_saber;

vmCvar_t		roar_allow_jetpack_command;
vmCvar_t		roar_allow_dropsaber_command;
vmCvar_t		roar_chat_protection;
vmCvar_t		roar_enable_ForceDuel;
vmCvar_t		roar_enable_TrainingDuel;
vmCvar_t		roar_enable_MeleeDuel;
vmCvar_t		roar_enable_NormalDuel;
vmCvar_t		roar_duel_begin_autobow;

vmCvar_t		roar_enable_ledgegrab;

vmCvar_t		roar_enable_ForceKickFlip;

vmCvar_t		roar_JK2yellowDFA;
vmCvar_t		roar_allow_KnockMeDown_command;

vmCvar_t		roar_saber_idle_damage;
vmCvar_t		roar_allow_samePlayerNames;
...
int		Tforce[MAX_CLIENTS];
int		Tsplat[MAX_CLIENTS];
//RoAR mod END
...
// DUEL_HEALTH
	...
	{ &roar_adminControl3, "cm_adminControl3", "0", CVAR_ARCHIVE, 0 , qtrue },
	{ &roar_adminControl4, "cm_adminControl4", "0", CVAR_ARCHIVE, 0 , qtrue },
	{ &roar_adminControl5, "cm_adminControl5", "0", CVAR_ARCHIVE, 0 , qtrue },
	{ &roar_emoteControl, "cm_emoteControl", "0", CVAR_ARCHIVE, 0 , qtrue },
	{ &g_clanPassword,         "cm_clanPassword",         "clanpass", CVAR_ARCHIVE | CVAR_INTERNAL, 0, qfalse },
...
//RoAR mod CUSTOM SAYINGS BEGIN
	...
	{ &roar_protect_on_saying,			"cm_protect_on_saying",			"is being protected",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_protect_off_saying,			"cm_protect_off_saying",			"lost his protection",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_protect_on_ALL_saying,			"cm_protect_on_ALL_saying",			"Everyone is being protected",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_protect_off_ALL_saying,			"cm_protect_off_ALL_saying",			"Everyone lost protection",		CVAR_ARCHIVE,					0, qfalse },

	{ &roar_RollTypes,			"cm_RollTypes",			"0",	0, CVAR_CHEAT },

	{ &roar_terminator_on_saying,			"cm_terminator_on_saying",			"has become the terminator",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_terminator_off_saying,			"cm_terminator_off_saying",			"lost terminator powers",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_terminator_on_ALL_saying,			"cm_terminator_on_ALL_saying",			"Everyone has become the ^1TERMINATOR!",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_terminator_off_ALL_saying,			"cm_terminator_off_ALL_saying",			"Everyone lost ^1terminator ^7powers",		CVAR_ARCHIVE,					0, qfalse },

	{ &roar_sleep_on_saying,			"cm_sleep_on_saying",			"has been put to sleep...",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_sleep_off_saying,			"cm_sleep_off_saying",			"has been awakened!",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_sleep_on_ALL_saying,			"cm_sleep_on_ALL_saying",			"Everyone has been put to sleep...",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_sleep_off_ALL_saying,			"cm_sleep_off_ALL_saying",			"Everyone has been awakened!",		CVAR_ARCHIVE,					0, qfalse },

	{ &roar_punish_on_saying,			"cm_punish_on_saying",			"is being PUNISHED!",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_punish_off_saying,			"cm_punish_off_saying",			"is behaving.",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_slap_saying,			"cm_slap_saying",			"has been slapped!",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_news1_time,			"cm_news1_time",			"0",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_news2_time,			"cm_news2_time",			"0",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_news3_time,			"cm_news3_time",			"0",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_news1_content,			"cm_news1_content",			"",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_news2_content,			"cm_news2_content",			"",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_news3_content,			"cm_news3_content",			"",		CVAR_ARCHIVE,					0, qfalse },

	{ &roar_sleep_on_saying,			"cm_sleep_on_saying",			"has been put to sleep...",		CVAR_ARCHIVE,					0, qfalse },

	{ &roar_BotFakePings,			"cm_BotFakePings",			"1",		CVAR_ARCHIVE,					0, qfalse },

	{ &roar_human_on_saying,			"cm_monk_on_saying",			"is a monk!",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_human_off_saying,			"cm_monk_off_saying",			"is no longer a monk",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_monk_on_ALL_saying,			"cm_monk_on_ALL_saying",			"Everyone is a ^4monk!",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_monk_off_ALL_saying,		"cm_monk_off_ALL_saying",			"Everyone is no longer a monk",		CVAR_ARCHIVE,					0, qfalse },

	{ &roar_teleport_saying,			"cm_teleport_saying",			"has been teleported!",		CVAR_ARCHIVE,					0, qfalse },

	{ &roar_scale_saying,			"cm_scale_saying",			"has been scaled by an admin!",		CVAR_ARCHIVE,					0, qfalse },

	{ &roar_renameclan_saying,			"cm_renameclan_saying",			"'s clan name was forcefully changed by an admin.",		CVAR_ARCHIVE,					0, qfalse },

	{ &roar_FPGRIPspeed,			"cm_FPGRIPspeed",			"1.0",		CVAR_ARCHIVE,					0, qfalse },

	{ &roar_demigod_on_saying,			"cm_demigod_on_saying",			"has become a demigod",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_demigod_off_saying,			"cm_demigod_off_saying",		"lost demigod powers",		CVAR_ARCHIVE,					0, qfalse },

	{ &roar_freeze_on_saying,			"cm_freeze_on_saying",			"is frozen solid",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_freeze_off_saying,			"cm_freeze_off_saying",			"thawed out",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_freeze_on_ALL_saying,		"cm_freeze_on_ALL_saying",		"Everyone is ^4FROZEN!",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_freeze_off_ALL_saying,		"cm_freeze_off_ALL_saying",		"Everyone has thawed out",		CVAR_ARCHIVE,					0, qfalse },

	{ &roar_splat_saying,				"cm_splat_saying",				"is about to feel\nEXTREME pain!",		CVAR_ARCHIVE,					0, qfalse },

	{ &roar_silence_on_saying,			"cm_silence_on_saying",			"has been silenced",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_silence_off_saying,			"cm_silence_off_saying",		"may now talk",		CVAR_ARCHIVE,					0, qfalse },
	...
	{ &clan_website, "clan_website", "www.website.com", CVAR_ARCHIVE|CVAR_SERVERINFO, 0, qtrue  },
	{ &clan_fullname, "clan_fullname", "^1Full Name", CVAR_ARCHIVE|CVAR_SERVERINFO, 0, qtrue  },
	{ &clan_initials, "clan_initials", "^1Initials", CVAR_ARCHIVE|CVAR_SERVERINFO, 0, qtrue  },
	{ &clan_founders, "clan_founders", "^6Founder(s)", CVAR_ARCHIVE|CVAR_SERVERINFO, 0, qtrue  },
	{ &clan_recruiting, "clan_recruiting", "Yes or No", CVAR_ARCHIVE|CVAR_SERVERINFO, 0, qtrue  },
	{ &clan_laming, "clan_laming", "^1Yes or No", CVAR_ARCHIVE|CVAR_SERVERINFO, 0, qtrue  },
	{ &clan_moreinfo, "clan_moreinfo", "MORE INFORMATION!", CVAR_ARCHIVE|CVAR_SERVERINFO, 0, qtrue  },
	...
	{ &roar_display_ending_duel_status,			"cm_display_ending_duel_status",			"1",		CVAR_ARCHIVE,					0, qfalse },

	{ &roar_elevator_1_hit_kill,			"cm_elevator_1_hit_kill",			"1",		CVAR_ARCHIVE,					0, qfalse },

	{ &roar_remove_duel_radius,			"cm_remove_duel_radius",			"1",		CVAR_ARCHIVE,					0, qfalse },

	{ &roar_grip_open_saber,			"cm_grip_open_saber",			"0",		CVAR_ARCHIVE,					0, qfalse },

	{ &roar_allow_jetpack_command,			"cm_allow_jetpack_command",			"1",		CVAR_ARCHIVE,			0, qfalse },

	{ &roar_allow_dropsaber_command,			"cm_allow_dropsaber_command",			"1",		CVAR_ARCHIVE,			0, qfalse },
	{ &roar_chat_protection,			"cm_chat_protection",			"1",		CVAR_ARCHIVE,			0, qfalse },
	{ &roar_enable_ForceDuel,			"cm_enable_ForceDuel",			"1",		CVAR_ARCHIVE,			0, qfalse },

	{ &roar_idle_AutoProtect_timer,			"cm_idle_AutoProtect_timer",			"30",		CVAR_ARCHIVE,					0, qfalse },

	{ &roar_enable_TrainingDuel,			"cm_enable_TrainingDuel",			"1",		CVAR_ARCHIVE,			0, qfalse },

	{ &roar_enable_MeleeDuel,			"cm_enable_MeleeDuel",			"1",		CVAR_ARCHIVE,			0, qfalse },

	{ &roar_enable_NormalDuel,			"cm_enable_NormalDuel",			"1",		CVAR_ARCHIVE,			0, qfalse },
	{ &roar_duel_begin_autobow,			"cm_duel_begin_autobow",			"1",		CVAR_ARCHIVE,			0, qfalse },
	{ &roar_JK2yellowDFA,			"cm_JK2yellowDFA",			"0",		CVAR_ARCHIVE,			0, qfalse },

	{ &roar_enable_ledgegrab,			"cm_enable_ledgegrab",			"0",		CVAR_ARCHIVE,			0, qfalse },

	{ &roar_enable_ForceKickFlip,			"cm_enable_ForceKickFlip",			"1",		CVAR_ARCHIVE,			0, qfalse },

	{ &roar_allow_KnockMeDown_command,			"cm_allow_KnockMeDown_command",			"0",		CVAR_ARCHIVE,			0, qfalse },

	{ &roar_saber_idle_damage,			"cm_saber_idle_damage",			"1",		CVAR_ARCHIVE,			0, qfalse },

	{ &roar_allow_auto_saber_switching,			"cm_allow_auto_saber_switching",			"0",		CVAR_ARCHIVE,			0, qfalse },

	{ &roar_empower_on_saying,			"cm_empower_on_saying",			"has become empowered",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_empower_off_saying,			"cm_empower_off_saying",			"lost empowerment",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_empower_on_ALL_saying,			"cm_empower_on_ALL_saying",			"Everyone has become ^5EMPOWERED!",		CVAR_ARCHIVE,					0, qfalse },
	{ &roar_empower_off_ALL_saying,			"cm_empower_off_ALL_saying",			"Everyone has become ^5unempowered!",		CVAR_ARCHIVE,					0, qfalse },


	//RoAR mod CUSTOM SAYINGS END

	{ &roar_motd_line,			"cm_motd_line",			"",		CVAR_ARCHIVE,					0, qfalse },
	{ &x_cstime,			"cm_motd_time",		"5",	CVAR_ARCHIVE,					0, qtrue },
	{ &roar_IdleSaberDmg,	"cm_IdleSaberDmg",		"1",	CVAR_ARCHIVE,					0, qtrue },
	{ &roar_allow_black_names,	"cm_allow_black_names",		"1",	CVAR_ARCHIVE,					0, qtrue },
...
#define JETPACK_REFUEL_RATE		500 //seems fair
